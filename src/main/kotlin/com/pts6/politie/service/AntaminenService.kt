...
import com.pts6.politie.service.api.CarResponse
import com.pts6.politie.service.api.JwtRequestParameters
...
class AntaminenService {
    ...
    fun getVehicleByLicensePlate(licensePlate: String): com.pts62.common.finland.dto.VehicleDto {

        // Example: xx-yy-69
        val antaminenCarUrl = "${this.getAntaminenUrl()}/vehicle/licensePlate/$licensePlate/"
        val request = Request
                .Builder()
                .url(antaminenCarUrl)
//                .header("Authorization", this.retrieveJwtToken())
